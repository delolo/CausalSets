...
public:
    ...
    // the surface sigma.
    TExtrinsicCurvature(int dimension, TGeometry *GeometryAbove, TGeometry *GeometryBelow, double rhoexp) {
    ...
    // the surface sigma.
    TExtrinsicCurvature(int dimension, TGeometry *GeometryAbove, TGeometry *GeometryBelow, int nexp) {
        this->dimension = dimension;
        this->GeometryAbove = GeometryAbove;
        this->GeometryBelow = GeometryBelow;
        this->totalvolume   = GeometryAbove->V + GeometryBelow->V;
